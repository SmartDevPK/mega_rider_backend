...
return [
    ...
    */
    ...
    'default_location' => [
    'ip' => '127.0.0.1',
    'iso_code' => 'NG',           // ISO code for Nigeria
    'country' => 'Nigeria',       // Country name
    'city' => 'Lagos',            // Default city (you can choose any)
    'state' => 'LA',              // State code (optional)
    'state_name' => 'Lagos',      // State name
    'postal_code' => '',          // Leave blank if not needed
