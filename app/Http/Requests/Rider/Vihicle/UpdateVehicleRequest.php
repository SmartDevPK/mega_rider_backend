...
namespace App\Http\Requests\Rider\Vihicle;
...
class UpdateVehicleRequest extends FormRequest
{
     ...
     * 
     * Form request class for validating vehicle update operations.
     * Handles validation rules and authorization for updating vehicle records.
     * 
     ...
     * @method array messages() Get custom validation messages for defined validation rules
     */
