...
namespace App\Http\Requests\Rider\Registration;
...
class RiderRegistrationRequest extends FormRequest
{
     ...
     * 
     * Handles validation and authorization for rider registration requests.
     * This form request validates all required information for a new rider including
     * personal details, vehicle information, work history, guarantor details, next of kin,
     * and required file uploads.
     * 
     * @method bool authorize() Determines if the user is authorized to make this request
     * @method array rules() Get the validation rules that apply to the request
     * @method array messages() Get custom error messages for validation failures
     * @method void prepareForValidation() Prepare the data for validation by normalizing email and phone
     */
